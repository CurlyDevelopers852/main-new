  ...
  return (
    <OuterBox id="contact" className="section-2">
      ...
      <ExternalBox>
        ...
        <BoxForm>
          <CustomTxt variant="body1">Hey Curly Developers, my name is</CustomTxt>
          <CustomInputs InputLabelProps={{ shrink: true }} />
          <CustomTxt variant="body1">and I want to discuss</CustomTxt>
          <CustomInputs InputLabelProps={{ shrink: true }} />
          <CustomTxt variant="body1">with you. You can reach me via my email</CustomTxt>
          <CustomInputs InputLabelProps={{ shrink: true }} />
          ...
          <CustomInputs label="Project details" multiline rows={4} variant="outlined" />
        </BoxForm>
